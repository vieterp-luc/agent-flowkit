...
**Orientation by entity type:** characters, creatures, visual_assets, generic_troops, factions → **VERTICAL**. Locations → **HORIZONTAL**. The worker handles this automatically based on `entity_type`.
