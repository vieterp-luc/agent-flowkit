    ...
    async def create(
        ...
        *,
        ...
        return cls(id=pid, name=name, description=description, story=story,
                   language=language, user_paygate_tier=user_paygate_tier, orientation=orientation, _repo=repo)
    ...
    async def add_video(
        ...
        *,
        ...
        return Video(id=vid, project_id=self.id, title=title,
                     video_story=video_story, display_order=display_order, _repo=self._repo)
